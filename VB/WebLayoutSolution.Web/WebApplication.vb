...
Namespace WebLayoutSolution.Web
    ...
    Partial Public Class WebLayoutSolutionAspNetApplication
        ...
        End Sub
        Private Sub WebLayoutSolutionAspNetApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs) Handles MyBase.DatabaseVersionMismatch
#If EASYTEST Then
            e.Updater.Update()
            e.Handled = True
#Else
